                ...
                <div class="mt-10 lg:-mx-4 relative relative-20 lg:mt-0 lg:col-start-1">
                    <div class="relative space-y-4">
                        <div class="flex items-end justify-center lg:justify-start space-x-4">
                            <img class="rounded-lg shadow-lg w-32 md:w-56" width="200" src="../assets/1.jpeg" alt="1"/>
                            <img class="rounded-lg shadow-lg w-40 md:w-64" width="260" src="../assets/logo.png" alt="2"/>
                        </div>
                        <div class="flex items-start justify-center lg:justify-start space-x-4 ml-12">
                            <img class="rounded-lg shadow-lg w-24 md:w-40" width="170" src="../assets/logo.png" alt="3"/>
                            <img class="rounded-lg shadow-lg w-32 md:w-56" width="200" src="../assets/1.jpeg" alt="4"/>
                        </div>
                    </div>
                </div>
            </div>
