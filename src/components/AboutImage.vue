...
<div class="relative bg-gray-800 p-5 mt-5">
    <div class="lg:grid lg:grid-flow-row-dense lg:grid-cols-2 lg:gap-12 lg:items-center">
        <div class="lg:col-start-2 md:pl-20">
            <h4 class="text-2xl leading-8 font-extrabold text-white tracking-tight sm:leading-9">
                Manage everything
            </h4>
            <ul class="mt-10">
                <li>
        ...
        <div class="mt-10 -mx-4 md:-mx-12 relative lg:mt-0 lg:col-start-1">
            <img :src="ImgPro" alt="illustration" class="imgPro relative mx-auto shadow-lg rounded w-100"/>
        </div>
    </div>
</div>
...
import ImgPro from '../assets/1.jpeg'
